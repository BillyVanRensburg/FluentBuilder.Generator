...
namespace FluentBuilder.Generator.Analyzers
{
    ...
    public sealed class StructBuilderAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "FBBLD015";

        private static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
            id: DiagnosticId,
            title: "Cannot generate builder for struct",
            messageFormat: "Cannot generate fluent builder for struct '{0}'",
        ...
        private static void Analyze(SymbolAnalysisContext context, INamedTypeSymbol attributeSymbol)
        {
            ...
            // Must be struct (TypeKind.Struct)
