...
namespace FluentBuilder.Generator.Analyzers
{
    ...
    public sealed class StaticClassBuilderAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "FBBLD009";

        private static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
            id: DiagnosticId,
            title: "Cannot generate builder for static class",
            messageFormat: "Cannot generate fluent builder for static class '{0}'",
        ...
        private static void Analyze(SymbolAnalysisContext context, INamedTypeSymbol attributeSymbol)
        {
            ...
            // Only check classes (static classes are always classes)
