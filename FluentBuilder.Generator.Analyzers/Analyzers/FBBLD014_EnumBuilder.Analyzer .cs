...
namespace FluentBuilder.Generator.Analyzers
{
    ...
    public sealed class EnumBuilderAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "FBBLD014";

        private static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
            id: DiagnosticId,
            title: "Cannot generate builder for enum",
            messageFormat: "Cannot generate fluent builder for enum '{0}'",
